package com.vehector.nextstaffchat.velocity.utils;
...
public final class VelocityColorUtil {
    ...
    public static Component parse(String input) {
        ...
        try { return MINI.deserialize(s); }
        catch (Exception e) { return LEGACY_AMP.deserialize(input); }
    }
